...
def firebase_auth_required(view_func):
    ...
    def wrapped_view(request, *args, **kwargs):
        # CORS middleware handles OPTIONS requests automatically, so we don't need to handle them here
        # If OPTIONS gets here, let CORS middleware handle it by not blocking it
...
def get_user_organization_data(request):
    try:
        ...
        users_data = [{
            ...
            'name': org_user.name,
            'send_email': org_user.send_email,
